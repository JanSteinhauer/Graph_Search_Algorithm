...
public interface Graph<N, A> {
    ...
    default Edge<N, A> addEdge(N start, N destination, String s) { //todo das hier habe ich neu hinzugefügt
        Optional<A> annotation = (Optional<A>) Optional.of(s);
        return addEdge(start, destination, annotation);
    }
